...
extern Text *startBlinkText;

extern gui::IGUIStaticText *tEndCongrats;
extern gui::IGUIStaticText *tEndScore;
extern gui::IGUIStaticText *tEndCarrots;
extern Text *textNewHighScore;
extern gui::IGUIStaticText *tLastHighScore;
