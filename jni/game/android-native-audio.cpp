...
bool createUriAudioPlayer(char* uri)// stringc complie error
{
    SLresult result;
...
bool createAssetAudioPlayer(char* filename) // stringc compile error
{
    SLresult result;
