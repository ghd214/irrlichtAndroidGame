...
IRRDRVROBJ = CNullDriver.cpp importgl.c COGLESDriver.cpp COGLESTexture.cpp COGLESExtensionHandler.cpp
...
LOCAL_MODULE := irlicht

LOCAL_CFLAGS := -DANDROID_NDK -DDISABLE_IMPORTGL -I/Users/ellis/Documents/SciGems/android-ndk-1.6_r1-darwin-x86-crystax/apps/irrlicht/project/include/
...
LOCAL_LDLIBS := /tmp/libsupc++.a /tmp/libstdc++.a -ldl -llog
